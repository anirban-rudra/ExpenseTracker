                        ...
                        var chart = new CanvasJS.Chart("chartContainer", {
                            ...
                            data: [{
                                ...
                                while($row_category = mysqli_fetch_array($run_category))
                                {
                                    ...
                                    $select_total_expense = "SELECT SUM(expense_amt) FROM expense WHERE expense_month='$current_month' ";
                                    ...
                                    $select_expense = "SELECT * FROM expense WHERE category_id='$category_id' AND expense_month='$current_month' ";
                                ...
                                ?>
                                    { y: <?php echo $round_off_percentage; ?>, label: "<?php echo $category_name;?>" },
        ...
        <div class="card shadow mb-4 pre-scrollable">
            ...
            <div class="card-body">
                ...
                <div class="progress mb-4">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo $roundoff_percentage_progress?>%"
