                    ...
                    <div class="row">
                        <div class="col">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-success" value="Set Budget" name="insert_btn">
                                </div>
                            ...
                            if (isset($_POST['insert_btn'])) {
                                ...
                                $insert_budget = "INSERT INTO budget(category_id, budget_amount, user_id) VALUES('$category_id', '$budget_amount', '$user_id')";

                                $run_budget = mysqli_query($conn, $insert_budget);

                                if ($run_budget === true) {

                                    echo "<div class='alert alert-success'>Budget Added</div>";
                                } else {
